...
@Component({
    selector: 'app-artesanals',
    templateUrl: './artesanals.page.html',
    styleUrls: ['./artesanals.page.scss'],
})

export class ArtesanalsPage implements OnInit {
    ...
    ngOnInit() {
        ...
        //this.dembarquePorts = DesembarquePorts;
    ...
    updateValues() {        
        this.tiene_matricula = this.tipo_registro; // this.tipo_registro == 1 ? 1 : null;
        // console.log('Tiene', this.tiene_matricula)
        // console.log('Tiene', this.tipo_registro)
    }
    ...
    async loadData(){
        ...
        let dataRegister = await Preferences.get({ key: 'dataRegistersArtesanal' });
        ...
        items.forEach((data) => {
            ...
            this.tipo_propulsion = data.tipo_propulsion;
            ...
            this.tiene_matricula = data.tiene_matricula;
    ...
    async saveInLocal() {
        ...
        if (this.id == 0) {
            ...
            object.numero_matricula = this.numero_matricula;
            ...
            object.status = 1;
            //news
            object.tipo_registro = this.tipo_registro;
            object.tipo_propulsion = this.tipo_propulsion;
            ...
            object.tiene_matricula = this.tiene_matricula;
            ...
            items.forEach((data) => {
                ...
                data.numero_matricula = this.numero_matricula;
                ...
                data.status = 1;
                //news
                data.tipo_registro = this.tipo_registro;
                data.tipo_propulsion = this.tipo_propulsion;
                ...
                data.tiene_matricula = this.tiene_matricula;
    ...
    calculateSize() {
        var largo = this.largo_bodegas;
        var alto = this.alto_bodegas;
        var ancho = this.ancho_bodegas;
        this.capacidad_bodegas = 0;
        if(largo && alto &&  ancho) {
    ...
    async searchVessel(){
        ...
        this.api.searchVessel("Bearer " + this.userToken, this.matricula_search+"/art").subscribe(response => {    
            loading.dismiss()        

            console.log("Response =>", response[0])

            if( response[0].data[0].type_boat == 'ART'){
                ...
                if(response[0] && response[0].data && response[0].data[0]){
                    ...
                    //new
                    this.tipo_registro = response[0].data[0].tipo_registro;
                    this.tipo_propulsion = response[0].data[0].tipo_propulsion;
                    ...
                    this.tiene_matricula = response[0].data[0].tiene_matricula;
